 ...
 */
router.post('/signup', validation_1.validateUserSignup, (req, res, next) => {
    (0, userController_1.signup)(req, res, next).catch(next);
});
router.get('/verify-email', (req, res, next) => {
    (0, userController_1.verifyEmail)(req, res, next).catch(next);
});
router.post('/login', [
    (0, express_validator_1.body)('email').isEmail(),
    (0, express_validator_1.body)('password').isLength({ min: 6 })
], (req, res, next) => {
    (0, userController_1.userLogin)(req, res, next).catch(next);
});
router.get('/websocket-docs', (req, res) => {
    res.json({
        direct_message: {
            type: 'direct_message',
            to: 'recipientUserId',
...
router.post('/direct-message', auth_1.authenticateUser, userController_1.sendDirectMessage);
router.post('/group-message', auth_1.authenticateUser, userController_1.sendGroupMessage);
